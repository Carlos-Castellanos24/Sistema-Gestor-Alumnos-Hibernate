...
@WebServlet("/ServletEliminarAsignacion")
public class ServletEliminarAsignacion extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.getRequestDispatcher("/WEB-INF/Asignacion/eliminarAsignacion.jsp").forward(req, resp);
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        ServicioAsignaciones servicioAsignaciones = new ServicioAsignaciones();
        servicioAsignaciones.eliminarAsignacion(asignacion);
