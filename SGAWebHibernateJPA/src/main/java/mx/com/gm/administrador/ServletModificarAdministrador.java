...
@WebServlet("/ServletModificarAdministrador")
public class ServletModificarAdministrador extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.getRequestDispatcher("/WEB-INF/Administrador/modificarAdministrador.jsp").forward(req, resp);
    }
