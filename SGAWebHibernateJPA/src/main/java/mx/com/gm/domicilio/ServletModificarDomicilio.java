...
@WebServlet("/ServletModificarDomicilio")
public class ServletModificarDomicilio extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.getRequestDispatcher("/WEB-INF/Domicilio/modificarDomicilio.jsp").forward(req, resp);
    }
