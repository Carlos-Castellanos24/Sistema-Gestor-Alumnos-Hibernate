                        ...
                        <nav class="navigation navbar navbar-expand-md navbar-dark ">
                            ...
                            <div class="collapse navbar-collapse" id="navbarsExample04">
                                <ul class="navbar-nav mr-auto">
                                    <li class="nav-item">
                                        <a class="nav-link" href="index.jsp#banner_main">Misión y Visión</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="index.jsp#contact">Comentarios</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="login.jsp">Administracion</a>
                                    </li>
                                </ul>
                            </div>
                        </nav>
